...
function initChart(chartData) {
    const options = {
        ...
        yaxis: {
            labels: {
                formatter: function (val) {
                    // Format values as is, rounded to one decimal place
        ...
        tooltip: {
            y: {
                formatter: function (val) {
                    // Format tooltip values as is, rounded to one decimal place
                    return `${val.toFixed(1)}M`;
                }
            }
        },
...
// Function to fetch chart data and initialize the chart
function fetchChartData() {
    // Assuming chartData is a global variable set in the HTML
    initChart(window.chartData);
}

// Call fetchChartData when the window loads
